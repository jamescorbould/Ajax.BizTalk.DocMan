namespace Ajax.BizTalk.DocMan.Pipelines
{
    using System;
    ...
    public sealed class SendInvoice : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"\" />      <Components>        <Component>          <Name>Ajax.BizTalk.DocMan.PipelineComponent.NotSt"+
"reamingBad,Ajax.BizTalk.DocMan.PipelineComponent.Base64Encode.NotStreamingBad, Version=1.0.0.0, Cult"+
"ure=neutral, PublicKeyToken=null</Name>          <ComponentName>NotStreamingBad</ComponentName>     "+
"     <Description />          <Version>1.0</Version>          <Properties>            <Property Name"+
...
"ged>true</CachedIsManaged>        </Component>      </Components>    </Stage>  </Stages></Document>";
        ...
        public SendInvoice()
        {
            ...
            IBaseComponent comp0 = Microsoft.BizTalk.PipelineOM.PipelineManager.CreateComponent("Ajax.BizTalk.DocMan.PipelineComponent.NotStreamingBad,Ajax.BizTalk.DocMan.PipelineComponent.Base64Encode.NotStreamingBad, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null");;
